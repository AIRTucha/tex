...
Anyway such a huge dataset are very exotica, typical dataset does not contain more than 268 milion of voxel and they are able to be mapped to the single texture map. It is about 600 of voxels per dimenssion in case of cubic shape of the volume. Our engine is able render this amount of voxel with an intaractive frame rate even in a very weak graphic card.\\
